...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/heelslideleft/model.json',
    metadata:'exercise/heelslideleft/model_meta.json',
    weights:'exercise/heelslideleft/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("slide your left heel in before straightening your leg", 1, 0.75), 10000);
}
