...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/seatedkneekickleft/model.json',
    metadata:'exercise/seatedkneekickleft/model_meta.json',
    weights:'exercise/seatedkneekickleft/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("kick your left leg up and put it down", 1, 0.75), 10000);
}
