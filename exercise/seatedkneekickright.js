...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/seatedkneekickright/model.json',
    metadata:'exercise/seatedkneekickright/model_meta.json',
    weights:'exercise/seatedkneekickright/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("kick your right leg up and put it down", 1, 0.75), 10000);
}
