...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/heelslideright/model.json',
    metadata:'exercise/heelslideright/model_meta.json',
    weights:'exercise/heelslideright/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("slide your right heel in before straightening your leg", 1, 0.75), 10000);
}
