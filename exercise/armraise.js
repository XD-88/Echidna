...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/armraise/model.json',
    metadata:'exercise/armraise/model_meta.json',
    weights:'exercise/armraise/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("raise your arms and put it down", 1, 0.75), 10000);
}
