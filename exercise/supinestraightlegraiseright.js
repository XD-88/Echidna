...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/supinestraightlegraiseright/model.json',
    metadata:'exercise/supinestraightlegraiseright/model_meta.json',
    weights:'exercise/supinestraightlegraiseright/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("lift your right leg up and put it down", 1, 0.75), 10000);
}
