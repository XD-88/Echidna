...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/supinestraightlegraiseleft/model.json',
    metadata:'exercise/supinestraightlegraiseleft/model_meta.json',
    weights:'exercise/supinestraightlegraiseleft/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("lift your left leg up and put it down", 1, 0.75), 10000);
}
