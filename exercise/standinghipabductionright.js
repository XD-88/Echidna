...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/standinghipabductionright/model.json',
    metadata:'exercise/standinghipabductionright/model_meta.json',
    weights:'exercise/standinghipabductionright/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("lift your right leg up sideways and put it down", 1, 0.75), 10000);
}
