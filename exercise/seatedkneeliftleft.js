...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/seatedkneeliftleft/model.json',
    metadata:'exercise/seatedkneeliftleft/model_meta.json',
    weights:'exercise/seatedkneeliftleft/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("lift your left knee up and put it down", 1, 0.75), 10000);
}
