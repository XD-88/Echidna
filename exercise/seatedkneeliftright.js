...
function setup() {
  ...
  const modelInfo = {
    model: 'exercise/seatedkneeliftright/model.json',
    metadata:'exercise/seatedkneeliftright/model_meta.json',
    weights:'exercise/seatedkneeliftright/model.weights.bin',
  };
...
function modelReady() {
  ...
  setTimeout(() => speakText("lift your right knee up and put it down", 1, 0.75), 10000);
}
